package com.futurespace.controller;
...
import com.futurespace.config.CurrentUser;
import com.futurespace.dto.ApiResponse;
import com.futurespace.dto.JwtAuthenticationResponse;
import com.futurespace.dto.LocalUser;
import com.futurespace.dto.LoginRequest;
import com.futurespace.dto.SignUpRequest;
import com.futurespace.dto.SignUpResponse;
import com.futurespace.exception.UserAlreadyExistAuthenticationException;
import com.futurespace.model.User;
import com.futurespace.security.jwt.TokenProvider;
import com.futurespace.service.UserService;
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
		try {
			...
			if (signUpRequest.isUsing2FA()) {
				QrData data = qrDataFactory.newBuilder().label(user.getEmail()).secret(user.getSecret()).issuer("futurespace").build();
